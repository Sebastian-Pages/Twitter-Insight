...
public class SparkSequenceFileExample {
    ...
    public static final String TABLE_NAME = "aleflohic:test"; //IL FAUT CHANGER LE NAMESPACE!
    ...
    public static Tuple2<ImmutableBytesWritable, Put> prepareForHbase(Tuple2<Long,String> x) {
        ...
        put.addColumn(ID_FAMILY, Bytes.toBytes("id"), Bytes.toBytes(x._1()));
        put.addColumn(TEXT_FAMILY, Bytes.toBytes("text"), Bytes.toBytes(x._2()));
	...
	public static void main(String[] args) throws Exception {
		...
		conf_hbase.set("hbase.mapred.outputtable", ID_TEXT);
